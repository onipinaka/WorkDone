...
function ContactUs() {
  return (
    ...
    <div className='flex flex-col justify-center bg-theme-login-blue gap-[38px] w-full max-w-screen-sm'>
        ...
        <div className='bg-white rounded-t-3xl flex justify-center pb-8'>
